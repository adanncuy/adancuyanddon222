...
def helpmessage():
    ...
    helpMessage =   "╔══[ Help Message ]" + "\n" + \
                    ...
                    "╚══[ •√Admin Bot√•]                                                                                    1.•√AdanNcuy•√ http://line.me/ti/p/~Ncuy001                                                                     2.•√DON222•√ : http://line.me/ti/p/~AlbertARD_"
                    ...
                    if msg.contentType == 0:
                        if text is None:
                            ...
                            if cmd == "help":
                                ...
                                start = time.time()
                                client.sendMessage(to, "Ah Ah Ah Ah Kencing ku Pelan Amat...")
                                elapsed_time = time.time() - start
                                client.sendMessage(to, "[ Speed ]\nKecepatan Kencing {} detik".format(str(elapsed_time)))
                            elif cmd == "runtime":
                                timeNow = time.time()
                                ...
                                client.sendMessage(to, "Fuck u kenapa Bot AdanNcuy & Don222 Di Restart Fuck u")
                                restartBot()
# Pembatas Script #
                            elif cmd == "autoadd on":
                                settings["autoAdd"] = True
                                client.sendMessage(to, "Berhasil Mengatifkan Cinta nya AdanNcuy & Don222")
                            elif cmd == "autoadd off":
                                settings["autoAdd"] = False
                                client.sendMessage(to, "Berhasil menonaktifkan Cinta nya AdanNcuy & Don222")
                            elif cmd == "autojoin on":
                                settings["autoJoin"] = True
                                client.sendMessage(to, "Berhasil mengaktifkan Gombalan Maut AdanNcuy & Don222")
                            elif cmd == "autojoin off":
                                settings["autoJoin"] = False
                                client.sendMessage(to, "Berhasil menonaktifkan Gombalan Maut AdanNcuy & Don222")
                            elif cmd == "autoleave on":
                                settings["autoLeave"] = True
                                client.sendMessage(to, "Berhasil mengaktifkan Di Pukulan Muat AdanNcuy & Don222")
                            elif cmd == "autoleave off":
                                settings["autoLeave"] = False
                                client.sendMessage(to, "Berhasil menonaktifkan Pukulan Maut AdanNcuy & Don222")
                            elif cmd == "autorespon on":
                                settings["autoRespon"] = True
                                client.sendMessage(to, "Berhasil mengaktifkan Ciuman AdanNcuy & Don222")
                            elif cmd == "autorespon off":
                                settings["autoRespon"] = False
                                client.sendMessage(to, "Berhasil menonaktifkan Ciuman AdanNcuy & Don222")
                            elif cmd == "autoread on":
                                settings["autoRead"] = True
                                client.sendMessage(to, "Berhasil mengaktifkan Penyamaran AdanNcuy & Don222")
                            elif cmd == "autoread off":
                                settings["autoRead"] = False
                                client.sendMessage(to, "Berhasil menonaktifkan Penyamaran AdanNcuy & Don222")
                                ...
                                client.sendMessage(to, "Berhasil mengaktifkan Mata Profile AdanNcuy & Don222")
                            elif cmd == "checkcontact off":
                                settings["checkContact"] = False
                                client.sendMessage(to, "Berhasil menonaktifkan Mata Profile AdanNcuy & Don222")
...
# Pembatas Script #
                                ...
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    ...
                                    for ls in lists:
                                        ...
                                        client.sendMessage(to, "Berhasil Menjadi Siluman Yang Anda Inginkan {}".format(contact.displayName))
                                ...
                                try:
                                    ...
                                    client.sendMessage(to, "Berhasil Mengembalikan Akun Kamu Sperti Manusia •By•√ AdanNcuy & Don222")
                                except Exception as e:
...
# Pembatas Script #
                                ...
                                if msg.toType == 2:
                                    ...
                                    if group.preventedJoinByTicket == False:
                                        ...
                                        client.sendMessage(to, "Group Sudah Di Hack AdanNcuy & Don222 {}openqr".format(str(settings["keyCommand"])))
                            elif cmd == 'groupticket on':
                                if msg.toType == 2:
                                    group = client.getGroup(to)
                                    if group.preventedJoinByTicket == False:
                                        client.sendMessage(to, "Grup qr sudah Di Hack AdanNcuy & Don222")
                                    else:
                                        group.preventedJoinByTicket = False
                                        client.updateGroup(group)
                                        client.sendMessage(to, "Berhasil Hack Group •By•√ AdanNcuy & Don222")
                            elif cmd == 'groupticket off':
                                if msg.toType == 2:
                                    group = client.getGroup(to)
                                    if group.preventedJoinByTicket == True:
                                        client.sendMessage(to, "Grup qr sudah Tidak Aman")
                                    else:
...
# Pembatas Script #
                                ...
                                if receiver in read['readPoint']:
                                    ...
                                    read['ROM'][receiver] = {}
                                    client.sendMessage(receiver,"Sider Mata AdanNcuy & Don222 Telah Aktif")
                                else:
                                    try:
                                        del read['readPoint'][receiver]
                                        del read['readMember'][receiver]
                                ...
                                if receiver not in read['readPoint']:
                                    client.sendMessage(receiver,"Mata Sider Di Nonaktifkan")
                                else:
                                    try:
                                        del read['readPoint'][receiver]
                                        del read['readMember'][receiver]
